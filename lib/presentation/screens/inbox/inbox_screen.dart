...
import 'package:flicker_mail/presentation/screens/inbox/widgets/message_search_delegate.dart';
import 'package:flicker_mail/presentation/screens/widgets/error_dialog.dart';
import 'package:flicker_mail/presentation/screens/widgets/option_dialog.dart';
...
class _InboxScreenState extends State<InboxScreen> with AutomaticKeepAliveClientMixin<InboxScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<EmailProvider>(
      builder: (context, emailProv, child) {
        return Scaffold(
          appBar: AppBar(
            title: Text(
