...
void _messageDetailsEntitySerialize(
  ...
  writer.writeString(offsets[4], object.htmlBody);
  writer.writeLong(offsets[5], object.id);
  writer.writeLong(offsets[6], object.messageDbId);
  writer.writeLong(offsets[7], object.messageId);
  writer.writeString(offsets[8], object.subject);
  writer.writeString(offsets[9], object.textBody);
}
...
MessageDetailsEntity _messageDetailsEntityDeserialize(
  ...
  final object = MessageDetailsEntity(
    ...
    htmlBody: reader.readStringOrNull(offsets[4]) ?? "",
    id: reader.readLong(offsets[5]),
    messageDbId: reader.readLong(offsets[6]),
    messageId: reader.readLong(offsets[7]),
    subject: reader.readStringOrNull(offsets[8]) ?? "",
    textBody: reader.readStringOrNull(offsets[9]) ?? "",
  );
  object.isarId = id;
  return object;
}
